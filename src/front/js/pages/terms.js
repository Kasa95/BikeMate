...
export const Terms = () => {
  ...
  return (
    <div className="container">
      ...
      <p> Welcome to BikeMate! </p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of BikeMate Inc. 's Website, located at www.bikemate.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions.Do not continue to use BikeMate if you do not agree to take
      ...
      <p>
        ...
        terminology or other words in the singular, plural, capitalization and /
        or he / she or they, are taken as interchangeable and therefore as
        referring to same.
      </p>
      <h3>
      ...
      <p>
        We employ the use of cookies.By accessing BikeMate, you agreed to use
        cookies in agreement with the BikeMate Inc. 's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, BikeMate Inc.and / or its licensors own the
        intellectual property rights for all material on BikeMate.All
        intellectual property rights are reserved.You may access this from
        BikeMate for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p> You must not: </p>
      <ul>
        <li> Republish material from BikeMate </li>
        <li> Sell, rent or sub - license material from BikeMate </li>
        <li> Reproduce, duplicate or copy material from BikeMate </li>
        <li> Redistribute content from BikeMate </li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the
        website.BikeMate Inc.does not filter, edit, publish or review Comments
        prior to their presence on the website.Comments do not reflect the views
        and opinions of BikeMate Inc., its agents and / or affiliates.Comments
        reflect the views and opinions of the person who post their views and
        opinions.To the extent permitted by applicable laws, BikeMate Inc.shall
      ...
      <p>
        BikeMate Inc.reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant BikeMate Inc.a non - exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of BikeMate Inc.; and(d) the link
      ...
      <p>
        ...
        interested in linking to our website, you must inform us by sending an e
        - mail to BikeMate Inc..Please include your name, your organization
      ...
      <p>
        No use of BikeMate Inc. 's logo or other artwork will be allowed for
